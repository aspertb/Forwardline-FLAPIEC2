...
public class CustomerHelper {
	...
	// UN-COMMENT GETCUSTOMER AND SET APPROPRIATE VALUE FOR OPERATION VALUE IN ORDER TO USE IT.
	...
	/*public Boolean isCustomer(LoginResponse loginResponse, String email) {
		...
		try {
			...
			Gson gson = new Gson();
			isCust = gson.fromJson(json.toString(), Boolean.class);
